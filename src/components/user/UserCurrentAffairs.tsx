...
const BASE_URL = "https://e-book-backend-production.up.railway.app/api/current-affairs";
...
const fetchCategories = async () => {
  try {
    ...
    const res = await fetch(
      "https://e-book-backend-production.up.railway.app/api/current-affairs/categories",
      {
        headers: {
