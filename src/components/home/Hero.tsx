...
export function Hero({ onNavigate, onOpenBook }: HeroProps) {
  return (
    <section
      className="relative min-h-[80vh] bg-gradient-to-br from-[#1d4d6a] via-[#2a5f7f] to-[#1d4d6a] text-white overflow-hidden flex items-center justify-center px-4 sm:px-8 lg:px-20"
    >
