            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button
                        ...
                        className="text-sm font-medium text-[#1d4d6a] hover:underline"
                    >
                        Mark all as read
                    </button>
                </div>
                ...
                {sortedNotifications.map((n) => (
                    <div
                        ...
                        className={`cursor-pointer flex items-start justify-between p-4 rounded-lg border transition ${n.unread
                                ? "bg-gray-50 border-[#1d4d6a]/30 hover:bg-gray-100"
                    ...
                    >
                        <div className="flex items-start gap-3">
                            <Bell
                                size={18}
                                className={`mt-1 ${n.unread ? "text-[#1d4d6a]" : "text-gray-400"
                                    }`}
                            />
                            <div>
                                <h3
